...
public class KubernetesDeploymentServiceImpl implements DeploymentService {
    ...
    private static final String NAMESPACE = "raghav-apps";
...
//                    "mc mirror --overwrite myminio/projects/%d/ /app/",
                    "mc mirror --overwrite myminio/lovable-clone-bucket/%d/ /app/",
                    projectId);
//            String initialSyncCmd = String.format(
//                    "mc mirror --overwrite myminio/lovable-clone-bucket/%d/ /app/",
////                    projectId);
...
//                    projectId);
            String watchCmd = String.format(
                    "nohup mc mirror --overwrite --watch myminio/lovable-clone-bucket/%d/ /app/ > /app/watch.log 2>&1 &",
                    projectId);
